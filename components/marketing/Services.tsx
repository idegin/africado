                        ...
                        >
                            ...
                            <div className={`relative h-[400px] lg:h-full overflow-hidden ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                                ...
                                <div className="absolute top-8 left-8">
                                    <div className="bg-primary text-primary-foreground p-5 rounded-none shadow-2xl border border-white/10">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {service.features.slice(0, 4).map((feature, fIndex) => (
                                            <div key={fIndex} className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm font-bold text-foreground/80 uppercase tracking-tight">{feature}</span>
                                            </div>
                                        ))}
                                    </div>
